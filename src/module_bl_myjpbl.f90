...
!----------------------------------------------------------------------
     ...
     &                 ,TKE_MYJ,EXCH_H,EXCH_M,USTAR,ZNT,EL_MYJ,PBLH,KPBL,CT   &  ! GHB, 200617: added exch_m
...
!
!BSF  End:
!!!      print *,'  nspec,nspecs,nspece = ',nspec,nspecs,nspece
...
!
          DO K=KTS,KTE-1
            ...
            EXCH_M(I,K,J)=AKMK(KFLIP)*DELTAZ
          ENDDO
!
!----------------------------------------------------------------------
!***
