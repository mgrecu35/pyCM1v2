...
FC   = gfortran
OPTS = -fPIC -ffree-form -ffree-line-length-none -O2 -finline-functions -fopenmp
CPP  = cpp -C -P -traditional -Wno-invalid-pp-token -ffreestanding
OMP  = -DOPENMP
#-----------------------------------------------------------------------------
...
cm1:		$(OBJS) cm1.o module_cm1_vars.F
			$(CPP) $(DM) $(DP) $(ADV) $(OUTPUTOPT)  module_cm1_vars.F > module_cm1_vars.f90
			$(CPP) $(DM) $(DP) $(ADV) $(OUTPUTOPT)  cm1_init.F > cm1_init.f90
			$(CPP) $(DM) $(DP) $(ADV) $(OUTPUTOPT)  cm1_interface.F > cm1_interface.f90
			$(FC) $(FFLAGS) $(OUTPUTINC) -c module_cm1_vars.f90
			$(FC) $(FFLAGS) $(OUTPUTINC) -c cm1_init.f90
			$(FC) $(OBJS) cm1.o $(FFLAGS) $(OUTPUTINC) $(OUTPUTLIB) $(LINKOPTS) -o ../run/cm1.exe
			$(FC) -shared -o cm1lib.so $(OBJS) module_cm1_vars.o cm1_init.o $(FFLAGS) $(OUTPUTINC) $(OUTPUTLIB) $(LINKOPTS) -lgfortran -lgomp
			$(AR) onefile.F $(SRC)
			mv onefile.F ../run
...
hifrq.o: input.o constants.o cm1libs.o adv.o adv_routines.o bc.o ib_module.o writeout_nc.o comm.o
...
solve2.o: constants.o input.o bc.o comm.o adv.o adv_routines.o sound.o sounde.o soundns.o soundcb.o anelp.o misclibs.o module_mp_nssl_2mom.o ib_module.o
